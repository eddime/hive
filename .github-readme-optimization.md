...
Output (all minified):
- `dist/bunery-darwin-arm64` - 58 MB
- `dist/bunery-darwin-x64` - 64 MB
- `dist/bunery-linux-x64` - 100 MB
- `dist/bunery-linux-arm64` - 93 MB
- `dist/bunery-windows-x64.exe` - 114 MB
