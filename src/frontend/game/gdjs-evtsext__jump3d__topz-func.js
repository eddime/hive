...
gdjs.evtsExt__Jump3D__TopZ.userFunc0x10a4418 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if (objects.length === 0) {
    return;
}
...
const objects = gdjs.evtsExt__Jump3D__TopZ.GDObjectObjects1;
gdjs.evtsExt__Jump3D__TopZ.userFunc0x10a4418(runtimeScene, objects, eventsFunctionContext);
