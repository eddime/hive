...
gdjs.evtsExt__Sticker__DefineHelperClasses.userFunc0xe40b68 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
...
class Sticker {
    ...
    updateRelativeCoordinates() {
        ...
        this.relativeZ = (object.getZ ? object.getZ() : 0) - this.basisOldZ;
    ...
    updateOldCoordinates() {
        ...
        this.ownerOldZ = object.getZ ? object.getZ() : 0;

        this.basisOldX = this.basisObject.getX();
        this.basisOldY = this.basisObject.getY();
        this.basisOldZ = this.basisObject.getZ ? this.basisObject.getZ() : 0;
    ...
    followPosition() {
        ...
        const currentZ = object.getZ ? object.getZ() : 0;
        if (object.getX() !== this.ownerOldX
            || object.getY() !== this.ownerOldY
            || currentZ !== this.ownerOldZ) {
            this.updateRelativeCoordinates();
        }
        const basisCurrentZ = basisObject.getZ ? basisObject.getZ() : 0;
        if (this.basisOldX !== basisObject.getX()
            || this.basisOldY !== basisObject.getY()
            || this.basisOldZ !== basisCurrentZ) {
            object.setPosition(
                basisObject.getX() + this.relativeX,
                basisObject.getY() + this.relativeY);
            if (object.setZ && basisObject.getZ) {
                object.setZ(basisObject.getZ() + this.relativeZ);
            }
        }
    }
...
gdjs.evtsExt__Sticker__DefineHelperClasses.userFunc0xe40b68(runtimeScene, eventsFunctionContext);
