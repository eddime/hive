...
gdjs.evtsExt__Jump3D__SetTopZ.userFunc0xe040f8 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if (objects.length === 0) {
    return;
}
...
const objects = gdjs.evtsExt__Jump3D__SetTopZ.GDObjectObjects1;
gdjs.evtsExt__Jump3D__SetTopZ.userFunc0xe040f8(runtimeScene, objects, eventsFunctionContext);
